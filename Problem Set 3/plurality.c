...
{
    int i = 0;
    int highest_votes = candidates[i].votes;
    string winner = candidates[i].name;
    for (i = 0; candidates[i].votes; i++)
    {
    ...
    int j = 0;
    for (j = 0; candidates[j].votes; j++)
    {
        // printf("%i: %i", candidates[j].votes, highest_votes);
